...
@router.get("/team_profile/{team_profile_id}", response_model=schemas.BaseTeamProfile, tags=['Team Profile'])
...
@router.get("/team_profiles/", response_model=List[schemas.BaseTeamProfile], tags=['Team Profile'])
...
@router.post("/new_team_profile/", response_model=schemas.BaseTeamProfile, tags=['Team Profile'])
def create_team_profile(team: schemas.CreateTeamProfile, db: Session = Depends(get_db)):
...
@router.patch("/update_team_profile/{team_profile_id}", response_model=schemas.BaseTeamProfile, tags=['Team Profile'])
def update_team(team_profile_id: int, team_profile: schemas.UpdateTeamProfile, db: Session = Depends(get_db)):
...
@router.delete("/delete_profile_team/{team_profile_id}", response_model=schemas.BaseTeamProfile, tags=['Team Profile'])
